...
public class BP 
{
	private final double bias=28000;
    private static double eta=0.0000000000001;
    ...
    private void adjustWeight(double[] delta, double[] layer, double[][] weight, 
    		double[][] prevWeight) 
    {
        layer[0] = bias;
    ...
    private double Transfer(double val)
    {
        return val;
    }
}
