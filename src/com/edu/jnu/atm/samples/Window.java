...
public class Window {
	...
	/**
	 * construct a new window to show the variation of sourcedata and
	 * predictdata RATE denotes error ratio
	 */
	...
	private ChartPanel LineChart(List<Double> sourceData, List<Double> predictData) {
		...
		JFreeChart jfreechart = ChartFactory.createLineChart("Forcasting Results", "Date", "Cash Flow", xydataset,
